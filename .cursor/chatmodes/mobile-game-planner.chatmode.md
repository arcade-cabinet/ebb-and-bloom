...
**ECS Architecture Focus**: All plans must align with Entity Component System patterns and Miniplex implementation.
...
- React Three Fiber integration patterns and reactive data flow
- React Three Fiber rendering pipeline and 3D scene management
...
- Integration points with React Three Fiber and Zustand
...
- React component reactive data requirements
- React Three Fiber scene rendering needs
...
- Always research latest Miniplex patterns and best practices
- Review React Three Fiber + ECS integration approaches
- Study mobile game performance optimization techniques
- Investigate React Three Fiber + ECS rendering strategies

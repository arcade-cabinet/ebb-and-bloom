    ...
    >
      ...
      <Container flexDirection="column" gap={16} alignItems="center">
        ...
        <Button
          ...
          width={400}
        >
          <Text fontSize={20} fontWeight="medium">🌱 Start New World</Text>
        </Button>
        ...
        {hasSaveGame && onContinueGame && (
          <Button
            ...
            width={400}
          >
            <Text fontSize={18} fontWeight="medium">🔄 Continue Evolution</Text>
          </Button>
        )}
        ...
        {onSettings && (
          <Button
            ...
            width={400}
          >
            <Text fontSize={16}>⚙️ Settings</Text>
          </Button>
        )}
      ...
      >
        ...
        <Text  fontSize={10} color={0xA0AEC0} opacity={0.7}>
          Generation 1+ driven by Yuka AI • Gen 1 = ECS Foundation
        </Text>
      </Container>

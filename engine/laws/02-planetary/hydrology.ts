...
export const Groundwater = {
   ...
   */
  rechargeRate_mmPerYear: (infiltration_mm: number, deepPercolationFraction: number): number => {
   ...
   */
  isSustainable: (extractionRate_m3PerYear: number, rechargeRate_m3PerYear: number): boolean => {

...
const BuildingRenderer: React.FC = () => {
  ...
  // Query buildings from ECS world - Poll for new buildings
  useEffect(() => {
    ...
    // Poll every 1000ms to catch newly constructed buildings
    const interval = setInterval(queryBuildings, 1000);

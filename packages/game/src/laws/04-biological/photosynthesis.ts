...
export const LightReactions = {
  ...
  netRate_umolCO2m2s: (
    ...
    const efficiency = LightReactions[`${plantType}_efficiency` as keyof typeof LightReactions] as number || 0.03;
...
export const OxygenProduction = {
  ...
  equilibriumO2_percent: (
    ...
    const netProduction = photosynthesisRate_GtPerYear - respirationRate_GtPerYear - weatheringRate_GtPerYear;

...
export const CooperationTheory = {
  ...
  shouldCooperateNonKin: (
    ...
    const expectedFutureBenefit = benefit * futureMeetingProbability * partnerReliability / discountRate;
...
export const ESS = {
   ...
   */
  hawkDoveESS: (resourceValue: number, injuryCost: number): { hawkFreq: number; doveFreq: number } => {

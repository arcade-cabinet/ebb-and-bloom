...
export const SoilFormation = {
   ...
   */
  texture: (
    parentRock: 'granite' | 'basalt' | 'limestone' | 'sandstone'
  ): {
    sand: number;
    silt: number;
    clay: number;
    ...
    const textures = {
      granite: { sand: 0.6, silt: 0.3, clay: 0.1 }, // Coarse
      basalt: { sand: 0.3, silt: 0.4, clay: 0.3 }, // Medium
      limestone: { sand: 0.1, silt: 0.4, clay: 0.5 }, // Fine
      sandstone: { sand: 0.8, silt: 0.15, clay: 0.05 }, // Very coarse
    };
...
export const NutrientCycling = {
   ...
   */
  depletionRate: (cropYield_kgPerHa: number, nutrient: 'N' | 'P' | 'K'): number => {

...
import type { Archetype, GenerationScale } from '@ebb/gen/schemas';
 ...
 */
export async function generateGen1DataPools(baseSeed: string, planet?: any, gen0Data?: any): Promise<any> {
 ...
 */
export async function generateGen3DataPools(planet: any, gen2Data: any, baseSeed: string): Promise<any> {
  ...
  const seedContext: Record<string, any> = {};
  if (gen2Data?.macro?.packTypeOptions?.[0]?.parameters) {
    const gen2Params = gen2Data.macro.packTypeOptions[0].parameters;
    // Extract pack-related context
  }
 ...
 */
export async function generateGen4DataPools(planet: any, gen3Data: any, baseSeed: string): Promise<any> {
 ...
 */
export async function generateGen5DataPools(planet: any, gen4Data: any, baseSeed: string): Promise<any> {
 ...
 */
export async function generateGen6DataPools(planet: any, gen5Data: any, baseSeed: string): Promise<any> {
